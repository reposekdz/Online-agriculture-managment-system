...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE article SET `article_type`='$_POST[articletype]',`title`='$_POST[title]', `article_description`='$_POST[description]', `article_img1`='$imgname1', `article_img2`='$imgname2', `article_img3`='$imgname3', `article_img4`='$imgname4', `article_img5`='$imgname5', `status`='$_POST[status]' where article_id='$_GET[editid]'";
	...
	$sql="INSERT INTO `article`(`article_id`, `article_type`,`title`, `article_description`, `article_img1`, `article_img2`, `article_img3`, `article_img4`, `article_img5`, `status`) VALUES ('','$_POST[articletype]','$_POST[title]','$description','$imgname1','$imgname2','$imgname3','$imgname4','$imgname5','Active')";
	if(!mysqli_query($con,$sql))
		{
