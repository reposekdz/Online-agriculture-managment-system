...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2023 at 09:32 AM
...
--
-- Table structure for table `adminchecker`
--

CREATE TABLE `adminchecker` (
  `id` int(11) NOT NULL,
  ...
  `product_purchase_bill_id` int(11) NOT NULL,
...
--
DELIMITER $$
CREATE TRIGGER `add_category` AFTER INSERT ON `category` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.category_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `add_city` AFTER INSERT ON `city` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.city_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `add_country` AFTER INSERT ON `country` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.country_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `customer_added` AFTER INSERT ON `customer` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.customer_id, `Inserted`)
$$
DELIMITER ;
...
--
-- Triggers `product_purchase_bill`
--
DELIMITER $$
CREATE TRIGGER `bills` AFTER INSERT ON `product_purchase_bill` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.product_purchase_bill_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `order` AFTER INSERT ON `purchase_order` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.purchase_order_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `seller_added` AFTER INSERT ON `seller` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.seller_id, NEW.seller_name, `Inserted`)
$$
DELIMITER ;
...
--
-- Triggers `selling_product`
--
DELIMITER $$
CREATE TRIGGER `product_add` AFTER INSERT ON `selling_product` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.selling_prod_id, NEW.product_name, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `newstate` AFTER INSERT ON `state` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.state_id, `Inserted`)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `new_worker` AFTER INSERT ON `worker` FOR EACH ROW INSERT INTO adminchecker VALUES(null, NEW.worker_id, `Inserted`)
$$
DELIMITER ;
...
--
ALTER TABLE `product_purchase_bill`
  MODIFY `product_purchase_bill_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `product_purchase_record`
--
ALTER TABLE `product_purchase_record`
  MODIFY `purchase_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `state`
  MODIFY `state_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
