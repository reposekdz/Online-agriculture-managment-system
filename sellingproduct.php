...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE selling_product SET  `category_id`='$_POST[category]', `product_name`='$_POST[productname]', `product_description`='$_POST[productdescription]', `product_img1`='$imgname1', `product_img2`='$imgname2', `cost`='$_POST[cost]',`quantity_type`='$_POST[quantitytype]', `status`='Active' WHERE selling_prod_id='$_GET[editid]'";
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Enter Farmer's Market record...</h4></center><hr>
