...
if(isset($_POST['submit']))
{
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id, country_id, city_id, pincode, mobile_no, email_id, password, bank_name, bank_branch, bank_IFSC, bank_acno, status) VALUES ('$_POST[sellername]','$_POST[selleraddress]','$_POST[state]','$_POST[country]','$_POST[city]','$_POST[pincode]','$_POST[mbnumber]','$_POST[emailid]','$_POST[password]','$_POST[bankname]','$_POST[branch]','$_POST[ifsccode]','$_POST[bankacnumber]','$_POST[status]')";	
	if(!mysqli_query($con,$sql))
		{
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Farmer/Seller Registration Panel</h2>
          <ol>
            ...
            <div class="row">
              ...
              <div class="col-md-3 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                  <h4>Register as Farmer/Seller</h4>
...
<div class="form-row">
	...
	Farmer/Seller Name  <font color="#FF0000">*</font>
