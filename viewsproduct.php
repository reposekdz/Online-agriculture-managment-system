  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>View Farmer's Market records...</h4></center><hr>
...
<?php
							...
							if(mysqli_num_rows($qsql)  == 0)
									{
										echo "<center>There is no Farmer's Market to display!!</center>";
									}
									else
									{
										?>
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[cost]</td>
						      <td>&nbsp;$rs[status]</td>
							  <td>&nbsp; <a href='sellingproduct.php?editid=$rs[selling_prod_id]' CLASS='btn btn-info'>Edit</a> <a href='viewsproduct.php?deleteid=$rs[selling_prod_id]' onclick='return delconfirm()' CLASS='btn btn-danger' >Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
